function [Sanctuary,Site,Deployment,Species]= extractInfoFromFilename2(filename)
...
%modified by Annamaria DeAngelis 3/30/2021 to convert Species output for
%dolphin to be "dolphins", "Ship" to be "ships", and "cod" to be 
%"atlanticcod" to maintain consistent filenames with previous deliverables
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ~whichspeciesPos
       ...
       whichspeciesPos= ismember(splitagain,specieslist);
        ...
        if strcmp(Species,"dolphin")
           Species= "dolphins";
        elseif strcmp(Species,"Ship")
            Species= "ships";
        elseif strcmp(Species,"cod")
            Species= "atlanticcod";
        else
            %do nothing
        end
