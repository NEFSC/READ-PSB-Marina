function [freqMat,daterange,daterangeN]= computeFreqMatrix(pathname, ExcelPresenceFile, detections)

%read in Excel table
hourlyPres= readtable([pathname, ExcelPresenceFile],'Sheet','HourlyPres');
