function summarizeDolphinDetections4(species)
...
wmd= readWMD_SQLiteTable_2inputs(pathname,filename,species); 
...
%fill in with absences
hourlyPresT= insertAbsences(hourlyPresT,'hourly');
