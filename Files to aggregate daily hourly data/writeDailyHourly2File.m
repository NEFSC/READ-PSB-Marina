function writeDailyHourly2File (currentfile_minke, pathname_minke)
...
%Annamaria DeAngelis
%4/28/20
%modified for GUI by Allison Stokoe 10/24/2020
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if isa(filename_minke,'cell')==1
    %multi
    nfiles= length(filename_minke);
    for n= 1:nfiles
        data= readtable([pathname_minke,filename_minke{n}],'ReadVariableNames',0);
